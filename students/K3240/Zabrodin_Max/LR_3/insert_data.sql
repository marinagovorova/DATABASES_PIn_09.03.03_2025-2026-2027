-- ============================================================
-- Laboratory work №3
-- Variant 9. Database "Wholesale Base"
-- Filling tables with working data
-- ============================================================

SET search_path TO wholesale;

-- ============================================================
-- Filling table: manufacturers
-- ============================================================
...
-- ============================================================
-- Filling table: measurement_units
-- ============================================================
...
-- ============================================================
-- Filling table: supplies
-- invoice_id is filled later after creating supply_invoices
-- ============================================================
...
-- ============================================================
-- Filling table: order_items
-- Sale unit price is higher than purchase unit price
-- to provide wholesale base income
-- ============================================================
...
-- ============================================================
-- Updating supplies with invoice_id values
-- This fills the invoice_id field according to IDEF1X
-- ============================================================
